En este ejercicio vamos a hacer unir la base de datos creada anteriormente con el boceto de codigo html creado anteriormemte, y lo vamos a mostra en la web.
